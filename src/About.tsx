...
//       <div className="w-full max-w-4xl grid grid-cols-2 gap-5 items-center justify-center">
...
//           <div className="rounded-2xl aspect-[4/3] w-full max-w-80 items-center justify-center">
//             <img className="absolute top-40 left-40 z-10 w-90 h-90 object-contain animate-slide-fade-in-right" src={image} alt=""  />
//           </div>
//         </div>
...
//                 <button className="self-start mt-4 border border-white/60 rounded-full px-6 py-2 text-sm font-medium hover:bg-white hover:text-black transition-colors">
//                     Download CV
//                 </button>
//             </a>
