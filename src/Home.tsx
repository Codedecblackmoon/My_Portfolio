    ...
    return (
        <>
            <section className="hero" id="home">
                ...
                <a href="#contact"
                 className="z-60 mt-8 sm:mt-16 md:mt-80 inline-block cursor-pointer bg-white text-black px-6 py-3 sm:px-7 sm:py-3.5 md:px-8 md:py-4 rounded-full text-xs sm:text-sm font-medium no-underline transition-all duration-300 hover:bg-black hover:text-white hover:scale-105 animate-bounce">Let's Connect</a>
