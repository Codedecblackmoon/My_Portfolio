...
//           {/* Left column: text */}
//           <div>
//             <h1 className=" text-left leading-none mb-8"
//             style={{
...
//             <h2 className="text-2xl text-left font-black tracking-tight mb-4">
//               {project.name}
//             </h2>

//             <p className="text-sm text-left leading-relaxed mb-4">
//               {project.description}
//             </p>


//             {project.story.map((paragraph, i) => (
//               <p key={i} className="text-sm text-left leading-relaxed mb-4 last:mb-0">
//                 {paragraph}
//               </p>
//             ))}

//             <p className="pt-4 text-sm text-left leading-relaxed mb-4">
//               {project.Skills}
//             </p>
